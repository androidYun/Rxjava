...
public class LoadButton extends View implements Animator.AnimatorListener  {
    ...
    public LoadButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mSuccessedDrawable == null) {
            mSuccessedDrawable = context.getResources().getDrawable(R.mipmap.ic_launcher);
        }
        if (mErrorDrawable == null) {
            mErrorDrawable = context.getResources().getDrawable(R.mipmap.ic_launcher);
        }
        if (mPauseDrawable == null) {
            mPauseDrawable = context.getResources().getDrawable(R.mipmap.ic_launcher);
        }
